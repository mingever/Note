...
2. 三种循环结构来完成循环控制
	...
	2. while循环：控制循环次数未知的循环

	3. do-while循环：用来完成至少需要一次的循环
...
2. - 通过private，default，protected，public实现
	- 一般将属性设为私有，再设置相应的set和get方法
	- 没有访问权限的都可以视为封装

3. 目的

4. - 隐藏类的实现细节，只能通过方法访问数据，限制不合理的访问
	- 便于修改，增强代码的可维护性
...
5. ==方法覆盖后，用子类对象去调用该方法，执行的是覆盖后的方法==
